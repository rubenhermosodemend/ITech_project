...
if (isset($_POST['login'])) {
    ...
    if ($user == "" || $pass == "") {
        $error = "Please, introduce the credentials";
    } else {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($passresult["pass"] == $pass) {
                ...
                header('Location: ../index-ingles.php');
            } else {
                $error = "The user and password are incorrect";
            }
        } else {
...
<html lang="es">
    ...
    <body> 
        <div class="container align-items-center col-4 py-5">
            ...
            <h2>Wellcome</h2>
            <form class="form-center border p-3 bg-light" role="form" method="POST" action="login_en.php">
...
?>
                ...
                <button type="submit" class="btn btn-secondary" name="salir"><a href="../index.php" style="text-decoration: none; color: white"> Back</a>  </button>
            </form>
        </div>
    </body>
