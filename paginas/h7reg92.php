...
if (isset($_POST['registrar'])){    
    ...
    if ($user==""|| $pass=="" || $pass2=="" || $birthdate=="" ){
        $error="Faltan valores por introducir";
    } 
    else {
        ...
        if ($term==false){
            $error="Acepte los términos y condiciones";
        }else{
...
<body>
      <div class="container align-items-center col-4 py-5">
        ...
        <h2>Registrate</h2>
        <form class="form-center border p-3 bg-light" role="form" method="POST" action="h7reg92.php">
          ...
          if (isset($_POST['registrar'])){  
            ...
            ?>
          <button type="submit" class="btn btn-secondary" name="registrar">Registrarse</button>
